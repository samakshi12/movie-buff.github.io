...
const ShowCard = ({name, image, id, summary, onStarMeClick, isStarred}) => {
   ...
   <SearchImgWrapper>
    ...
    <p>{summaryStripped}</p>
    <ActionSection>
        <Link href={`my-app/show/${id}`} target ="_blank" rel="noreferrer">Read more</Link>
        <StarBtn ref={starBtnRef} type="button" onClick={handleStarClick}><StarIcon active={isStarred}/> </StarBtn>
    </ActionSection>
    </SearchCard>
    );
};
